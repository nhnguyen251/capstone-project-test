  ...
  render() {
    return (
      <div id='customer-list' className='card bg-light' >
        <h4 className='card-header bg-primary text-white'>List of Users</h4>
        <table className='table'>
          ...
          <p style={{'paddingLeft':'10px'}}>
            <input style={{width:'fit-content'}} className='btn btn-outline-primary' type={'button'} onClick={this.props.handleNewCustomerClick} value="Add New User" />
          </p>
      </div>
    )
  }
